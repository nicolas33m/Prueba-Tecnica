...
if data:
    for item in data["Items"]:
        ...
        for hourly_entity in item["HourlyEntities"]:
            ...
            cursor.execute('INSERT INTO "Demanda de Energía no regulada"("id", "Fecha","code", "hora1", "hora2","hora3","hora4","hora5","hora6","hora7","hora8","hora9","hora10","hora11","hora12","hora13","hora14","hora15","hora16","hora17","hora18","hora19","hora20","hora21","hora22","hora23","hora24") VALUES (%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s, %s,%s, %s,%s);',
